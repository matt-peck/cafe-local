...
exports.forgot = async (req, res) => {
  ...
  if (!user) {
    req.fllash('error', 'No account with that email exists.');
...
exports.reset = async (req, res) => {
  ...
  // if there is a user show the passwort reset form
...
exports.update = async (req, res) => {
  ...
  // setPassword provided by passport plugin
